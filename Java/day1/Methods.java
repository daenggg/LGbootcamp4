...
//    static : main 메서드에서 객체 생성 없이 바로 호출하기 위해 필요
    static void printGreeting() {
        System.out.println("안녕하세요! Java메서드입니다.");
    }

    //    반환값 없음, 매개변수 있음
//    이름(name)을 받아서 인사말을 출력한다
    static void greet(String name) {
        // name : 메서드 외부에서 전달받은 값으루 담는 매개변수(Parameter)
...
//    컴파일러가 호출시 전달되는 인수의 타입/개수를 보고 알맞은 메서드를 선택한다
//    반환 타입만 다른 건 오버로딩이 아님! -> 예전CS면접에서 자주 나왔음.
...
//        TODO 실습 문제
         ...
         *  어떤 스트링 s 가 있다면 길이는 s.length() 로 구하시면 됩니다.
         * 4. 피보나치 수열의 n번째 값을 재귀로 구하는 메서드를 작성하세요.
         * fib(0) = 0, fib(1)=1, fib(n) = fib(n-1)+fib(n-2)
         * 참고로 잊지마세요. 메서드는 main바깥에서 작성하시고 main 에서 호출하세요
         * main밑에 함수를 작성하셔도 ok
         * */
