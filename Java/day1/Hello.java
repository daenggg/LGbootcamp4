 ...
 * 중요 : 클래스명은 반드시 파일명(확장자 제외)과 동일해야 한다!
 * 이 파일이름이 Hello 이므로 실제 클래스명은 Hello로 지정한다.
...
/*         1. 자신의 이름과 좋아하는 숫자를 화면에 출력해보세요
            ...
            3. 여러 줄 주석으로 Java특징 중 하나를 설명하는 주석을 직접 작성해보세요.
* */
//        Todo 풀이
//        1번문제 , + type
        System.out.println("유승규");
        System.out.println("5");
//        type을 쓴 풀이
        String myName = "홍길동";
        int myNumber = 7;
        System.out.println("이름: " + myName);
        System.out.println("숫자: " + myNumber);
//        2번 문제
        System.out.printf("이름: %s, 나이:%d%n", "홍길이", 25);
        System.out.printf("이름: %s, 나이:%d%n", myName, myNumber);
//         3번 문제
        /*
         * 플랫폼 독립성이란?
