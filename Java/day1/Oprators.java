...
//        TODO 실습문제
//        1. 두 정수를 입력받아 합, 차, 곱, 몫, 나머지를 출력하세요
...
//        2.
        int checkNum = 27;
        boolean isDivisibleBy3 = (checkNum % 3 == 0);
        System.out.println(isDivisibleBy3);

//        3.
        int todoA = 8;
        int todoB = 13;
        int smaller = (todoA < todoB) ? todoA : todoB; // 같으면 todoB 출력
        System.out.println(smaller);

//        4.
        int personAge = 20;
        boolean personHasID = true;
        boolean canEnter = (personAge >= 19 && personHasID);

        System.out.println(canEnter);

        int minorAge = 17;
        boolean minorCanEnter = (minorAge >= 19) && personHasID;
        System.out.println(minorCanEnter);
