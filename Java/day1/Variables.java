...
//        작은 작료형 -> 큰 자료형 : 자동으로 변환된다. 데이터 손실 없음
...
//        데이터 손실이 발생할 수 있으니 주의!
        ...
        int castedFromLong = (int) bigLong;// 범위초과 시 값이 잘릴 수 있음
...
//        정수를 문자열로 변환
        ...
        System.out.println("\"123\" -> int : " + parsedInt + 1); //괄호가 없어서 1231로 나옴
...
//        TODO 실습 문제
         ...
         * 변수를 선언하고 출력하세요
         *
         * 2. 원의 반지름을 10으로 설정하고 넓이 (pi x r2)을 계산해보세요
         * pi는 final 상수로 선언하세요
         *
         * 3. 문자열"3.14"를 double 타입으로 변환해보세요
         * 힌트 : Double.pareDouble()
         * */
...
//        1
        String todoName = "홍길동";
        int todoNum = 5;
        double todoHeight = 100;
        char todoBloodType = 'B';
