...
public class Modifier {
    static void main(String[] args) {
         ...
         * */
        Counter c1 = new Counter("카운터 1");
        Counter c2 = new Counter("카운터 2");
        Counter c3 = new Counter("카운터 3");
...
//    static 메서드 : 객체 없이 클래스명.메서드()로 호출 가능
        ...
        System.out.println("최댓값: " + MathUtils.max(17, 42));
     ...
     * toFanhrenheit() : 화씨 반환 (공식 C * 9/5 + 32)
     * toKelvin() : 캘빈 반환 (공식 C + 273.15)
...
class Temperature {
    ...
    //    절대영도 유효성 검사를 위한 섭씨 setter
    public void setCelsius(double c) {
        if (c < ABSOLUTE_ZERO) {
            System.out.println("절대영도보다 낮을 수 없습니다.");
            return;
        }
        this.celsius = c;
    }
