...
function updateUI(): void {
    const elOwner = document.getElementById("owner") as HTMLElement;
    const elBank = document.getElementById("bank") as HTMLElement;
    const elBalance = document.getElementById("balance") as HTMLElement;
    const elHistory = document.getElementById("history") as HTMLElement;
